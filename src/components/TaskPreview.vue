<template>
  <section class="task-preview grid" :class="{ sticky: cmp === 'taskTitle' || cmp === 'checkbox' }"
  ...
  <TaskActionBar v-if="isActionBarOpen" @toggleActionBar="toggleActionBar" @remove="remove"></TaskActionBar>
</template>
